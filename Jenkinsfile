pipeline {
    ...
    tools {
        ...
        nodejs 'node-8' // А NodeJS нужен для фронта
    }
    ...
    stages {
        ...
        stage('Send Notification to Slack') {
            steps {
                sh 'curl -X POST -H \'Content-type: application/json\' --data \'{\"text\":\"Иван Шубин собрал приложение.\"}\' https://hooks.slack.com/services/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'
            }
        }
    }
}
